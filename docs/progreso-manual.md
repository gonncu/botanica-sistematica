...
- `130. Compositae`, parcial: tribus `1. Vernonieae`, `2. Eupatorieae`, `3. Astereae` y `4. Inuleae` completas; tribu `5. Heliantheae` parcial hasta `34. Wedelia`.
...
- Ultimo commit subido antes de esta tanda: `5fa00ae Add Compositae Heliantheae Eclipta genera keys`.

## Proxima familia consecutiva

- `130. Compositae`, continuar tribu `5. Heliantheae` desde `35. Aspilia`, pagina 504 del manual (`PDF_PAGE=511`).
