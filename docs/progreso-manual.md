...
- `130. Compositae`, parcial: tribus `1. Vernonieae`, `2. Eupatorieae`, `3. Astereae`, `4. Inuleae` y `5. Heliantheae` completas.
...
- Ultimo commit subido antes de esta tanda: `a9acf1f Add Compositae Heliantheae Spilanthes genera keys`.

## Proxima familia consecutiva

- `130. Compositae`, continuar tribu `6. Helenieae` desde `43. Jaumea`, pagina 509 del manual (`PDF_PAGE=516`).
