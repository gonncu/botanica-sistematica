...
- `130. Compositae`, parcial: tribus `1. Vernonieae`, `2. Eupatorieae` y `3. Astereae` completas; tribu `4. Inuleae` parcial hasta `24. Stuckertiella`.
...
- Ultimo commit subido antes de esta tanda: `9f85015 Add Compositae Inuleae early genera keys`.

## Proxima familia consecutiva

- `130. Compositae`, continuar tribu `4. Inuleae` desde `25. Gnaphalium`, pagina 495 del manual (`PDF_PAGE=502`).
